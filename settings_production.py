...
DEBUG = False
TEMPLATE_DEBUG = False  #was DEBUG, turned off for deployment
...
DATABASE_NAME = os.path.join(SITE_ROOT, 'db') + '/file.db'
...
SECRET_KEY = 'f)n_5hgbqwk$x7tka=o3np_ud$(1816kx4io=eprqm%nw#m##o'
