...
def film110_1p5():
    ...
    if 0:
        #horizontal
        myfilestr=os.path.join(mydirectory,'gfield80597.bt7')
        qz,I,Ierr,mon0=read_data(myfilestr)
        ax=fig.add_subplot(1,3,1)
        ax.errorbar(qz,I,Ierr,marker='s',linestyle='None',mfc='red',mec='red',ecolor=None,label='sf')
        
        myfilestr=os.path.join(mydirectory,'gfield80598.bt7')
        qz,I,Ierr,mon=read_data(myfilestr)
        Ierr=Ierr*mon0/mon
        I=I*mon0/mon
        ax.errorbar(qz,I,Ierr,marker='s',linestyle='None',mfc='black',mec='black',ecolor=None,label='nsf')
    ...
    if 1:
        ...
        myfilestr=os.path.join(mydirectory,'gfield80599.bt7')
        qz,I,Ierr,mon=read_fpx(myfilestr)
        Ierr=Ierr*mon0/mon
        I=I*mon0/mon
        Inuc_sf=I
        ...
        #plt.ylabel('Intensity (arb. units)')
        if 1:
            myfilestr=os.path.join(mydirectory,'gfield80600.bt7')
            qz,I,Ierr,mon=read_fpx(myfilestr)
            Ierr=Ierr*mon0/mon
            I=I*mon0/mon
            Inuc_nsf=I
