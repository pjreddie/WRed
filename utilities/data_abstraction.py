...
class TripleAxis(object):
        ...
        def translate(self,dataset):
                ...
                self.translate_physical_motors(dataset)
                self.translate_primary_motors(dataset)
        ...
        def translate_primary_motors(self,dataset):
                ...
                print 'translating primary motors',dataset.data.a3
...
def processfile(myfilestr):
        #myfilestr=r'c:\bifeo3xtal\jan8_2008\9175\mesh53439.bt7'
        #myfilestr=os.path.join('..','test_data','mesh53439.bt7')
        print myfilestr
