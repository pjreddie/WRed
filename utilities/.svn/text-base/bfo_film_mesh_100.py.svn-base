...
if __name__ == '__main__':
    Nu = 10000
    aspect = 1.0
    mydirectory=r'C:\BiFeO3film\Aug10_2009'
    #myfilebase='cmesh'
    myend='bt9'
    xc,yc,zc=readmeshfiles(mydirectory,'meshb',myend,eflag='hhl') #Rm temp
    #xf,yf,zf=readmeshfiles(mydirectory,'meshe',myend,eflag='hkk') #0
    #xg,yg,zg=readmeshfiles(mydirectory,'meshd',myend,eflag='hkh') #-1.3
    print 'matplotlib'
