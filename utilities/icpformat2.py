...
class ICP(object):
    ...
    def splitfile(self,filename):
        ...
        filebase=match.group('base')
        fileseq_number=match.group('seq')
        file_end=os.path.splitext(filename)[1]
        return filebase, fileseq_number, file_end
